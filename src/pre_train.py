...
from pre_train_model import ClashRoyaleDataset
...
# 1. データの準備
dataset = ClashRoyaleDataset('../data/ranking_train.csv', '../data/cards.json')
...
save_path = os.path.join(save_dir, "deck_encoder.pth")
